...
The OEDC, an economic consortium of developed nations, estimates its member nations have on average 25 homeless people per 10,000 of the total population [source](https://www.oecd.org/en/topics/sub-issues/affordable-housing/homelessness.html). Here in the United States data from 2024 estimates about 23 people per 10,000 [source](https://www.developmentaid.org/news-stream/post/157797/homelessness-statistics-in-the-world). Although it seems other wealthy nations also struggle with housing their most vulnerable populations, one must ask if there is a better way. 
